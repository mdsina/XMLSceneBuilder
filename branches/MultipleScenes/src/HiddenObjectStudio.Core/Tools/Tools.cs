...
namespace HiddenObjectStudio.Core
{
	public class Tools
	{
        ...
        public static string GetPathBetweenFilesFolder(string startDiPath, string finalDiPath)
        {
            ...
            {
                startDiPath = startDiPath.ToLower();
                startDiPath = startDiPath.Replace("\\\\","\\");

                finalDiPath = finalDiPath.ToLower();
                finalDiPath = finalDiPath.Replace("\\\\", "\\");
        ...
        public static string CompareStringsInTxtFile(string filePathFirst, string filePathSecond)
        {
            ...
            filePathFirst = filePathFirst.ToLower();
            filePathSecond = filePathSecond.ToLower();
