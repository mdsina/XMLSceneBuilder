	...
	class FileName
	{
		...
		public string TextureName
		{
			get
			{
				...
				{
                    string textureName;
					textureName = HiddenObjectStudio.Core.Tools.CutDigitsFromHead(HiddenObjectStudio.Core.Tools.FilterString(TranslitName()));
		...
		public string NodeName
		{
			get 
			{
				string nodeName	= HiddenObjectStudio.Core.Tools.FilterBrackets(HiddenObjectStudio.Core.Tools.FilterString(TextureName).Replace(".", "_").Replace("-", "_"));
