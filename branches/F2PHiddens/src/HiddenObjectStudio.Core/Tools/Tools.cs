...
namespace HiddenObjectStudio.Core
{
	public class Tools
	{
        ...
        public static void TryToLoad(XmlDocument xmlDoc,string path)
        {
            try
            {
                xmlDoc.Load(path);
        ...
        public static void CopyDirectory(DirectoryInfo di, DirectoryInfo outputDi)
        {
        ...
        public static void MakeNormalFilesAttribute(DirectoryInfo di)
        {
            foreach (FileInfo fi in di.GetFiles())
            {
